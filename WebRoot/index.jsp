		...
		function addfavorite(){
			var ua = navigator.userAgent.toLowerCase();
			 if (ua.indexOf("360se") > -1){
			  	...
			  	window.external.AddToFavoritesBar('${dynamicURL}/authority/loginInit.action','企业增值税发票数据分析系统管理');//IE8
			 }else if (document.all){
			  	window.external.addFavorite('${dynamicURL}/authority/loginInit.action','企业增值税发票数据分析系统管理');
			 }else{
	...
	// 			alert("父类节点无法点击哦...");
		...
		function loadMenu(resourceType, treeObj){
            ...
            data = [
	            ...
	            {"accessPath":"<c:url value='/PageServlet?method=getFirstPage'/>","checked":false,"delFlag":0,"parentID":3,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":7,"resourceName":"进项基本数据","resourceOrder":0,"resourceType":""},
	            {"accessPath":"<c:url value='/PageServlet?method=getFirstOutPage'/>","checked":false,"delFlag":0,"parentID":3,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":8,"resourceName":"销项基本数据","resourceOrder":0,"resourceType":""},
            
	            {"accessPath":"","checked":false,"delFlag":0,"parentID":1,"resourceCode":"","resourceDesc":"","resourceGrade":2,"resourceID":2,"resourceName":"数据分析","resourceOrder":0,"resourceType":""},
	            {"accessPath":"inputTaxView.jsp","checked":false,"delFlag":0,"parentID":2,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":32,"resourceName":"进项数据可视化","resourceOrder":0,"resourceType":""},
	            {"accessPath":"outputTaxView.jsp","checked":false,"delFlag":0,"parentID":2,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":39,"resourceName":"销项数据可视化","resourceOrder":0,"resourceType":""},
	            {"accessPath":"contrast.jsp","checked":false,"delFlag":0,"parentID":2,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":5,"resourceName":"进销项数据对比","resourceOrder":0,"resourceType":""},
	            {"accessPath":"","checked":false,"delFlag":0,"parentID":2,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":6,"resourceName":"商品增值税可视化","resourceOrder":0,"resourceType":""},
	           
	            {"accessPath":"","checked":false,"delFlag":0,"parentID":1,"resourceCode":"","resourceDesc":"","resourceGrade":2,"resourceID":16,"resourceName":"数据操作","resourceOrder":0,"resourceType":""},
	            {"accessPath":"","checked":false,"delFlag":0,"parentID":16,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":17,"resourceName":"进项数据的添加","resourceOrder":0,"resourceType":""},
	            {"accessPath":"","checked":false,"delFlag":0,"parentID":16,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":18,"resourceName":"销项数据的添加","resourceOrder":0,"resourceType":""},
	            {"accessPath":"","checked":false,"delFlag":0,"parentID":16,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":33,"resourceName":"数据的导出","resourceOrder":0,"resourceType":""},
	           
	            {"accessPath":"","checked":false,"delFlag":0,"parentID":1,"resourceCode":"","resourceDesc":"","resourceGrade":2,"resourceID":24,"resourceName":"统计报表","resourceOrder":0,"resourceType":""},
	            ];
			/*
		...
		<div id="top_links">
			<div id="top_op">
				<ul>
					<li>
						...
						<span>${sessionScope.session_user.uName }</span>
					</li>
					<li>
			...
			<div id="top_close">
				<a href="javascript:void(0);" onclick="logout();" target="_parent">
					<img alt="退出系统" title="退出系统" src="images/common/close.jpg" style="position: relative; top: 20px; left: 25px;">
				</a>
			</div>
		</div>
	</div>
